...
void main() {
  ...
  group('MarvelCharacterRepositoryImpl: Exceptions tests', () {
    test(
        ...
        () async {
      when(() => mockDataSource.getCharacterById(1))
  ...
  group('MarvelCharacterRepositoryImpl: Success test', () {
    ...
    final characterOverview =
        CharacterOverviewEntityMock.characterOverviewEntity;
    test(
        'should return CharacterOverviewEntity when getCharacterById is called',
        () async {
      when(() => mockDataSource.getCharacterById(1))
          .thenAnswer((_) async => characterOverview);
    ...
    test(
        'should return List<CharacterPreviewEntity> when getFilteredLCharactersList is called',
        () async {
      when(() => mockDataSource.getFilteredLCharactersList(
              CharacterByContentType.comics, 1, 0))
          .thenAnswer((_) async => [characterPreview]);
