...
void main() {
  ...
  group('MarvelCharacterRepositoryImpl', () {
    ...
    test('should return CharacterOverviewEntity when getCharacterById is called', () async {
      final character = CharacterOverviewEntity(id: testId, name: 'Spider-Man', thumbnail: 'thumbnail.png', description: 'Description');
    ...
    test('should return a list of CharacterPreviewEntity when getCharacters is called', () async {
      ...
      when(() => mockDataSource.getCharacters(testOffset)).thenAnswer((_) async => characterList);
    ...
    test('should return CustomException when getCharacters throws an unexpected error', () async {
      when(() => mockDataSource.getCharacters(testOffset)).thenThrow(Exception('Unexpected error'));
    ...
    test('should return filtered characters list when getFilteredLCharactersList is called', () async {
      ...
      when(() => mockDataSource.getFilteredLCharactersList(CharacterByContentType.comics, testId, testOffset)).thenAnswer((_) async => characterList);
    ...
    test('should return CustomException when getFilteredLCharactersList throws CustomException', () async {
      ...
      when(() => mockDataSource.getFilteredLCharactersList(CharacterByContentType.comics, testId, testOffset)).thenThrow(exception);
    ...
    test('should return CustomException when getFilteredLCharactersList throws an unexpected error', () async {
      when(() => mockDataSource.getFilteredLCharactersList(CharacterByContentType.comics, testId, testOffset)).thenThrow(Exception('Unexpected error'));
    ...
    test('should return a list of CharacterPreviewEntity when searchCharacters is called', () async {
      final characterList = [CharacterPreviewEntity(id: testId, name: 'Spider-Man', thumbnail: 'thumbnail.png')];

      when(() => mockDataSource.searchCharacters(testName)).thenAnswer((_) async => characterList);
    ...
    test('should return CustomException when searchCharacters throws CustomException', () async {
      ...
      when(() => mockDataSource.searchCharacters(testName)).thenThrow(exception);
    ...
    test('should return CustomException when searchCharacters throws an unexpected error', () async {
      when(() => mockDataSource.searchCharacters(testName)).thenThrow(Exception('Unexpected error'));
